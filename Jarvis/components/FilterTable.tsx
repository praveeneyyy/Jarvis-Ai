...
const PILLS: Record<Status, { label: string; cls: string }> = {
  todo: { label: "To do", cls: "bg-amber-500/10 text-amber-500 border border-amber-500/20" },
  progress: { label: "In Progress", cls: "bg-cyan-500/10 text-cyan-400 border border-cyan-500/20" },
  done: { label: "Completed", cls: "bg-emerald-500/10 text-emerald-400 border border-emerald-500/20" },
};
...
export default function FilterTable({ initialRows = ROWS }: FilterTableProps) {
