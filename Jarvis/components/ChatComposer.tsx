...
export default function ChatComposer({
  ...
  return (
    <div className="flex h-[288px] w-full max-w-[23.75rem] flex-col self-start overflow-hidden rounded-[14px] bg-surface shadow-card">
      {/* header — tabs + actions */}
      ...
      <div className="mt-auto shrink-0 p-1.5">
        ...
        >
          <input
            ...
            className="min-h-[1.125rem] bg-transparent text-[13px] leading-[1.4] text-ink outline-none placeholder:text-ink-3"
          />
          <div className="flex items-center justify-end">
            <button
              ...
              style={{
                background: canSend ? "var(--ink, #ffffff)" : "var(--line-strong, #333333)",
                color: canSend ? "var(--surface, #000000)" : "var(--ink-2, #888888)",
              }}
            >
